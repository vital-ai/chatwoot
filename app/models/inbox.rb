...
class Inbox < ApplicationRecord
  ...
  def callback_webhook_url
    ...
    when 'Channel::TwilioSms'
      webhook_url('/twilio/callback')
    when 'Channel::Sms'
      webhook_url("/webhooks/sms/#{channel.phone_number.delete_prefix('+')}")
    when 'Channel::Line'
      webhook_url("/webhooks/line/#{channel.line_channel_id}")
    when 'Channel::Whatsapp'
      webhook_url("/webhooks/whatsapp/#{channel.phone_number}")
    end
  end
